...
" Edited LineNr and CursorLineNr to be displayed as grey
hi LineNr       guifg=grey 			guibg=bg          ctermfg=grey
hi CursorLineNr       guifg=grey 			guibg=bg          ctermfg=grey 	term=bold 
